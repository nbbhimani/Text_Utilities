...
export default function TextForm(props) {
    ...
    return (
        ...
        <div>
            ...
            <button className="btn btn-primary mx-1 my-1" disabled={text.length===0} type="submit" onClick={speak} >Speak</button>
        ...
        <div className={`container my-3 text-${props.mode==='light'?'dark':'light'}`}>
            ...
            <p>{text.split(" ").filter((element)=>{return element.length!==0}).length} words and {text.length} characters with spaces</p>
